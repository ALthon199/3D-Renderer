...
cl /I "include\SDL2" /I "include" src\*.c /Fe"bin\main.exe" /Fo"bin\\" /link /LIBPATH:"lib\x86" SDL2.lib SDL2main.lib shell32.lib user32.lib gdi32.lib legacy_stdio_definitions.lib /SUBSYSTEM:CONSOLE
if %errorlevel% neq 0 (
    echo BUILD FAILED!
    pause
    exit /b %errorlevel%
